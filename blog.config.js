...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'star皆空', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '黑眼圈达人🐼', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://cmrsilo.top', // 网站地址
  ...
  CONTACT_GITHUB: process.env.NEXT_PUBLIC_CONTACT_GITHUB || 'https://github.com/cm340', // 你的github个人主页 例如 https://github.com/tangly1024
  ...
  TITLE: process.env.NEXT_PUBLIC_TITLE || 'star皆空', // 站点标题 ，被notion中的页面标题覆盖；此处请勿留空白，否则服务器无法编译
  HOME_BANNER_IMAGE:
